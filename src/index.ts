 ...
 * @param additionalLicenses an array of licenses to check in addition to the standard list found in https://github.com/filiptronicek/osi-license-checker/blob/main/src/resources/licenses.json
 */
